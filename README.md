# CKEditor 5 editor build for Merstham CC Website

This repository presents a CKEditor 5 editor build generated by the [Online builder tool](https://ckeditor.com/ckeditor-5/online-builder)

### Custom modules

- ReadMore - Inserts a special anchor that will show where to display the "Read More" link when viewing a news summary.
